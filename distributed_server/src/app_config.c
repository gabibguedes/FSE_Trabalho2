...
void load_config(){
  ...
  cJSON *this_server_ip = cJSON_GetObjectItem(root, "ip_servidor_distribuido");
  cJSON *this_server_port = cJSON_GetObjectItem(root, "porta_servidor_distribuido");
  ...
  app_config.this_server_ip = this_server_ip->valuestring;
  app_config.this_server_port = this_server_port->valueint;
